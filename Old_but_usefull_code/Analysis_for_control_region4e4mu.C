...
void CLoop::Book() {
    ...
    h_inva_mass = new TH1F("inva_mass","Invariant mass lepton system",80,60e3,300e3);
    /*h_invamumu1_mass = new TH1F("invaee1_mass","Invariant mass ee system",200,0,200e3);
    h_invamumu2_mass = new TH1F("invaee2_mass","Invariant mass ee system",200,0,200e3);

    // Isolation variables Histograms
    h_pt0cone30 = new TH1F("pt0cone30","lepton 1 isolation",10,0,10e3);
    h_pt1cone30 = new TH1F("pt1cone30","lepton 2 isolation",10,0,10e3);
    h_pt2cone30 = new TH1F("pt2cone30","lepton 3 isolation",10,0,10e3);
    h_pt3cone30 = new TH1F("pt3cone30","lepton 4 isolation",10,0,10e3);
...
void CLoop::Fill(double weight) {
    ...
    for (int ilep=0; ilep<lep_n; ilep++) {
        ...
        if (lep_n==4) {
          ...
          lep_charg.push_back(make_pair(lep_charge->at(ilep),ilep));
        }
    ...
    if (lep_n==4) {
      ...
      if (l%13==0 && qtotal==0){ //&& pair1_charge<0 && pair2_charge<0 ){//&& lep_pt->at(vect_pt[3].second)>25e3 && lep_pt->at(vect_pt[2].second)>20e3) {
        ...
        //Ordering by charge
        //sort(lep_charg.begin(), lep_charg.end());
        ...
        /*double inv_2mum02=sqrt(2*lep_pt->at(lep_charg[0].second)*lep_pt->at(lep_charg[2].second)*(cosh(lep_eta->at(lep_charg[0].second)-lep_eta->at(lep_charg[2].second))-cos(lep_phi->at(lep_charg[0].second)-lep_phi->at(lep_charg[2].second))));
        double inv_2mum13=sqrt(2*lep_pt->at(lep_charg[1].second)*lep_pt->at(lep_charg[3].second)*(cosh(lep_eta->at(lep_charg[1].second)-lep_eta->at(lep_charg[3].second))-cos(lep_phi->at(lep_charg[1].second)-lep_phi->at(lep_charg[3].second))));
        double inv_2mum03=sqrt(2*lep_pt->at(lep_charg[0].second)*lep_pt->at(lep_charg[3].second)*(cosh(lep_eta->at(lep_charg[0].second)-lep_eta->at(lep_charg[3].second))-cos(lep_phi->at(lep_charg[0].second)-lep_phi->at(lep_charg[3].second))));
        double inv_2mum12=sqrt(2*lep_pt->at(lep_charg[1].second)*lep_pt->at(lep_charg[2].second)*(cosh(lep_eta->at(lep_charg[1].second)-lep_eta->at(lep_charg[2].second))-cos(lep_phi->at(lep_charg[1].second)-lep_phi->at(lep_charg[2].second))));
        */
        /*di_mass.push_back(abs(inv_2mum02-91.18e3));
        di_mass.push_back(abs(inv_2mum13-91.18e3));
        di_mass.push_back(abs(inv_2mum03-91.18e3));
        di_mass.push_back(abs(inv_2mum12-91.18e3));
        double correct_pair;*/
        if (inv_4m>60e3) {
          h_inva_mass->Fill(inv_4m,weight);
        }

        /*correct_pair=*min_element(di_mass.begin(),di_mass.end());

        cout << "Intento\n" <<correct_pair;
        if ((correct_pair+91.18e3==inv_2mum02) ^ (91.18e3-correct_pair==inv_2mum02)) {
          h_invamumu1_mass->Fill(inv_2mum02,weight);
          h_invamumu2_mass->Fill(inv_2mum13,weight);
          h_pt0cone30->Fill(lep_ptcone30->at(lep_charg[0].second),weight);
          h_pt1cone30->Fill(lep_ptcone30->at(lep_charg[2].second),weight);
          h_pt2cone30->Fill(lep_ptcone30->at(lep_charg[1].second),weight);
          h_pt3cone30->Fill(lep_ptcone30->at(lep_charg[3].second),weight);
          if (inv_2mum02>84e3 && inv_2mum02<98e3 && lep_ptcone30->at(lep_charg[1].second)<4e3 && lep_ptcone30->at(lep_charg[3].second)<4e3) {
            if (inv_4m<130e3 && inv_4m>117e3) {
              h_final_cut->Fill(inv_4m,weight);
            }
          }
        }
        if ((correct_pair+91.18e3==inv_2mum12)^(91.18e3-correct_pair==inv_2mum12)) {
          h_invamumu1_mass->Fill(inv_2mum12,weight);
          h_invamumu2_mass->Fill(inv_2mum03,weight);
          h_pt0cone30->Fill(lep_ptcone30->at(lep_charg[1].second),weight);
          h_pt1cone30->Fill(lep_ptcone30->at(lep_charg[2].second),weight);
          h_pt2cone30->Fill(lep_ptcone30->at(lep_charg[0].second),weight);
          h_pt3cone30->Fill(lep_ptcone30->at(lep_charg[3].second),weight);
          if (inv_2mum12>84e3 && inv_2mum12<98e3 && lep_ptcone30->at(lep_charg[0].second)<4e3 && lep_ptcone30->at(lep_charg[3].second)<4e3) {
            if (inv_4m<130e3 && inv_4m>117e3) {
              h_final_cut->Fill(inv_4m,weight);
            }
          }
        }
        if ((correct_pair+91.18e3==inv_2mum03)^(91.18e3-correct_pair==inv_2mum03)) {
          h_invamumu1_mass->Fill(inv_2mum03,weight);
          h_invamumu2_mass->Fill(inv_2mum12,weight);
          h_pt0cone30->Fill(lep_ptcone30->at(lep_charg[0].second),weight);
          h_pt1cone30->Fill(lep_ptcone30->at(lep_charg[3].second),weight);
          h_pt2cone30->Fill(lep_ptcone30->at(lep_charg[1].second),weight);
          h_pt3cone30->Fill(lep_ptcone30->at(lep_charg[2].second),weight);
          if (inv_2mum03>84e3 && inv_2mum03<98e3 && lep_ptcone30->at(lep_charg[1].second)<4e3 && lep_ptcone30->at(lep_charg[2].second)<4e3) {
            if (inv_4m<130e3 && inv_4m>117e3) {
              h_final_cut->Fill(inv_4m,weight);
            }
          }
        }
        if ((correct_pair+91.18e3==inv_2mum13)^ (91.18e3-correct_pair==inv_2mum13)) {
          h_invamumu1_mass->Fill(inv_2mum13,weight);
          h_invamumu2_mass->Fill(inv_2mum02,weight);
          h_pt0cone30->Fill(lep_ptcone30->at(lep_charg[1].second),weight);
          h_pt1cone30->Fill(lep_ptcone30->at(lep_charg[3].second),weight);
          h_pt2cone30->Fill(lep_ptcone30->at(lep_charg[0].second),weight);
          h_pt3cone30->Fill(lep_ptcone30->at(lep_charg[2].second),weight);
          if (inv_2mum13>84e3 && inv_2mum13<98e3 && lep_ptcone30->at(lep_charg[0].second)<4e3 && lep_ptcone30->at(lep_charg[2].second)<4e3) {
            if (inv_4m<130e3 && inv_4m>117e3) {
              h_final_cut->Fill(inv_4m,weight);
            }
          }
...
void CLoop::Style() {
    ...
    h_lep_eta->Write();
    h_inva_mass->Write();
    /*h_invamumu1_mass->Write();
    h_invamumu2_mass->Write();

...
void CLoop::Fill(double weight) {
    ...
    if (lep_n==4) {
      ...
      if (l%24==0 && pair1_charge<0 && pair2_charge<0 ){//&& lep_pt->at(vect_pt[3].second)>25e3 && lep_pt->at(vect_pt[2].second)>20e3) {
        ...
        /*h_pt0cone30->Fill(lep_ptcone30->at(vect_pt[3].second),weight);
        h_pt1cone30->Fill(lep_ptcone30->at(vect_pt[2].second),weight);
        h_pt2cone30->Fill(lep_ptcone30->at(vect_pt[1].second),weight);
        h_pt3cone30->Fill(lep_ptcone30->at(vect_pt[0].second),weight);*/
        double inv_4m;

...
void CLoop::Book(double lumFactor) {
    ...
    h_elec_0_iso_FCTight_topo = new TH1F("elec_0_iso_FCTight_topo","lepton 1 isolation",2,0,2);
    h_elec_0_iso_FCTight_topo_dphi_bdte_btag_rnn_pte_omega_mle_mreco_tpt = new TH1F("elec_0_iso_FCTight_topo_dphi_bdte_btag_rnn_pte_omega_mle_mreco_tpt","lepton 1 isolation",2,0,2);
      ...
      if (ql==qtau && angle<3*pi/4 && trigger_decision && lepton_id && trigger_match) {
        ...
        if (signal_events){
          ...
          if (cuts==c_bdte||cuts==c_all) {
            h_bdt_e_score_topo_dphi_btag_iso_rnn_pte_omega_mle_mreco_tpt->Fill(tau_0_ele_bdt_score_trans,weight);
          }
          ...
          if (cuts[1]==1) {
            ...
            if (inside) {
              ...
              h_sum_pt_topo_dphi_bdte->Fill(tau_0_p4->Pt()+pt_tau_nu+muon_0_p4->Pt()+pt_lep_nu,weight);
            }
            if (outside_lep) {
              h_reco_mass_met_outside_topo_dphi_bdte->Fill(reco_mass_outside,weight);
              h_lep_pt1nu_topo_dphi_bdte->Fill(tau_0_p4->Pt(),weight);
              h_sum_pt_topo_dphi_bdte->Fill(tau_0_p4->Pt()+muon_0_p4->Pt()+neutrino_pt,weight);
            }
            if (outside_tau){
              h_reco_mass_met_outside_topo_dphi_bdte->Fill(reco_mass_outside,weight);
            ...
            if (cuts[2]==1 || n_jets==0) {
              ...
              if (inside) {
                ...
                h_sum_pt_topo_dphi_bdte_btag->Fill(tau_0_p4->Pt()+pt_tau_nu+muon_0_p4->Pt()+pt_lep_nu,weight);
              }
              if (outside_lep) {
                ...
                h_sum_pt_topo_dphi_bdte_btag->Fill(tau_0_p4->Pt()+muon_0_p4->Pt()+neutrino_pt,weight);
              }
              if (outside_tau){
                h_reco_mass_met_outside_topo_dphi_bdte_btag->Fill(reco_mass_outside,weight);
              ...
              if (cuts[3]==1) {
                ...
                if (inside) {
                  ...
                  h_sum_pt_topo_dphi_bdte_btag_iso->Fill(tau_0_p4->Pt()+pt_tau_nu+muon_0_p4->Pt()+pt_lep_nu,weight);
                }
                if (outside_lep) {
                  ...
                  h_sum_pt_topo_dphi_bdte_btag_iso->Fill(tau_0_p4->Pt()+muon_0_p4->Pt()+neutrino_pt,weight);
                }
                if (outside_tau){
                  h_reco_mass_met_outside_topo_dphi_bdte_btag_iso->Fill(reco_mass_outside,weight);
                ...
                if (cuts[4]==1) {
                  ...
                  if (inside) {
                    ...
                    h_sum_pt_topo_dphi_bdte_btag_iso_rnn->Fill(tau_0_p4->Pt()+pt_tau_nu+muon_0_p4->Pt()+pt_lep_nu,weight);
                  }
                  if (outside_lep) {
                    ...
                    h_sum_pt_topo_dphi_bdte_btag_iso_rnn->Fill(tau_0_p4->Pt()+muon_0_p4->Pt()+neutrino_pt,weight);
                  }
                  if (outside_tau){
                    h_reco_mass_met_outside_topo_dphi_bdte_btag_iso_rnn->Fill(reco_mass_outside,weight);
                  ...
                  if (cuts[5]==1) {
                    ...
                    if (inside) {
                      ...
                      h_sum_pt_topo_dphi_bdte_btag_iso_rnn_pte->Fill(tau_0_p4->Pt()+pt_tau_nu+muon_0_p4->Pt()+pt_lep_nu,weight);
                    }
                    if (outside_lep) {
                      ...
                      h_sum_pt_topo_dphi_bdte_btag_iso_rnn_pte->Fill(tau_0_p4->Pt()+muon_0_p4->Pt()+neutrino_pt,weight);
                    }
                    if (outside_tau){
                      h_reco_mass_met_outside_topo_dphi_bdte_btag_iso_rnn_pte->Fill(reco_mass_outside,weight);
                    ...
                    if (cuts[6]==1) {
                      ...
                      if (inside) {
                        ...
                        h_sum_pt_topo_dphi_bdte_btag_iso_rnn_pte_omega->Fill(tau_0_p4->Pt()+pt_tau_nu+muon_0_p4->Pt()+pt_lep_nu,weight);
                      }
                      if (outside_lep) {
                        ...
                        h_sum_pt_topo_dphi_bdte_btag_iso_rnn_pte_omega->Fill(tau_0_p4->Pt()+muon_0_p4->Pt()+neutrino_pt,weight);
                      }
                      if (outside_tau){
                        h_lep_pt1_topo_dphi_bdte_btag_iso_rnn_pte_omega_outside->Fill(tau_0_p4->Pt(),weight);
                        h_reco_mass_met_outside_topo_dphi_bdte_btag_iso_rnn_pte_omega->Fill(reco_mass_outside,weight);

...
for t in trees:
	if "1" in sys.argv[1]:
		...
		os.system("hadd out/Zjets"+t+".root out/Zmumu_*_sys1_[0-9]"+t+".root out/Zee_*_sys1_[0-9]"+t+".root")
	...
	if "2" in sys.argv[1]:
		...
		os.system("hadd out/Zjets"+t+".root out/Zmumu_*_sys2_[0-9]"+t+".root out/Zee_*_sys2_[0-9]"+t+".root")

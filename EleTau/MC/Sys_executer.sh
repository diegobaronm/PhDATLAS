...
then
	...
	hadd out/Signal_Sherpa$2.root out/Ztautau_sherpa*_sys*.root
	hadd out/Signal_PoPy$2.root out/Ztautau_201_sys*.root
	hadd out/Zjets$2.root out/Zmumu_*_sys*.root out/Zee_*_sys*.root

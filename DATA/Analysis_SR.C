...
void CLoop::Book() {
    ...
    */
    ...
    h_muon_0_iso_FCTightTrackOnly_FixedRad_jetn_btag = new TH1F("muon_0_iso_FCTightTrackOnly_FixedRad_jetn_btag","lepton 1 isolation_jetn_btag",20,0,10);
    h_muon_0_iso_FCTightTrackOnly_FixedRad_jetn_btag_iso2_rnn_ptmu_omega_mreco = new TH1F("muon_0_iso_FCTightTrackOnly_FixedRad_jetn_btag_iso2_rnn_ptmu_omega_mreco","lepton isolation_jetn_btag_iso2_rnn_ptmu_omega_mreco",20,0,10);
    ...
    h_et0cone20_jetn_btag_iso_rnn_ptmu_omega_mreco = new TH1F("et0cone20_jetn_btag_iso_rnn_ptmu_omega_mreco","lepton isolation2_jetn_btag_iso_rnn_ptmu_omega_mreco",60,-5e3,10);
          ...
          if (cuts[1]==1 || n_jets==0) {
            ...
            if (cuts[2]==1) {
              ...
              if (cuts[3]==1) {
                ...
                if (cuts[4]==1) {
                  h_met_jetn_btag_iso_rnn_ptmu->Fill(met_reco_p4->Pt(),weight);
                  h_lep_pt0_jetn_btag_iso_rnn_ptmu->Fill(muon_0_p4->Pt(),weight);
                  h_lep_pt1_jetn_btag_iso_rnn_ptmu->Fill(tau_0_p4->Pt(),weight);

                  if (inside90) {
                    h_reco_mass_jetn_btag_iso_rnn_ptmu->Fill(reco_mass,weight);
                  }
                  if (outside90_lep) {
                    h_reco_mass_met_outside_jetn_btag_iso_rnn_ptmu->Fill(reco_mass_outside,weight);
                  }
                  if (outside90_tau){
                    h_reco_mass_met_outside_jetn_btag_iso_rnn_ptmu->Fill(reco_mass_outside,weight);
                  }
                  ...
                  if (cuts[5]==1) {
                    ...
                    if (inside90) {
                      //h_reco_mass_jetn_btag_iso_rnn_ptmu_omega->Fill(reco_mass,weight);
                      h_lep_pt1_jetn_btag_iso_rnn_ptmu_omega_inside->Fill(tau_0_p4->Pt(),weight);
                    }
                    if (outside90_lep) {
                      h_lep_pt1_jetn_btag_iso_rnn_ptmu_omega_outside->Fill(tau_0_p4->Pt(),weight);
                      //h_reco_mass_met_outside_jetn_btag_iso_rnn_ptmu_omega->Fill(reco_mass_outside,weight);
                    }
                    if (outside90_tau){
                      h_lep_pt1_jetn_btag_iso_rnn_ptmu_omega_outside->Fill(tau_0_p4->Pt(),weight);
...
void CLoop::Style() {
    ...
    */
    ...
    h_et0cone20_jetn_btag_iso_rnn_ptmu_omega_mreco->Write();

...
//by  b_branchname->GetEntry(ientry); //read only this branch
    ...
    for (Long64_t jentry=0; jentry<nLoop;jentry++) {
        ...
        if (weight_total != 0) {
            ...
            eventWeight = weight_total*lumFactor*zpt_weight*muon_0_NOMINAL_MuEffSF_HLT_mu26_ivarmedium_OR_HLT_mu50_QualMedium_IsoNone*muon_0_NOMINAL_MuEffSF_IsoFCTightTrackOnly_FixedRad*muon_0_NOMINAL_MuEffSF_Reco_QualMedium
            ...
            *jet_NOMINAL_central_jets_global_effSF_JVT*jet_NOMINAL_central_jets_global_ineffSF_JVT*jet_NOMINAL_forward_jets_global_effSF_JVT*
            jet_NOMINAL_forward_jets_global_ineffSF_JVT*jet_NOMINAL_global_effSF_MV2c10/*_FixedCutBEff_85*/*jet_NOMINAL_global_ineffSF_MV2c10/*_FixedCutBEff_85*/*tau_0_NOMINAL_TauEffSF_JetRNNtight;
        }

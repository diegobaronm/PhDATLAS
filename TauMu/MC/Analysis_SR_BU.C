    ...
    if (n_muons==1 && n_taus==1 && trigger_decision && lepton_id && trigger_match) {
      ...
      if (ql!=qtau && angle<3*pi/4){
        ...
        if (inside) {
          ...
          h_Z_pt_truth_inside->Fill(truth_Z_p4->Pt()/1000,weight);
        ...
        if (outside_tau) {
          ...
          h_Z_pt_truth_outside->Fill(truth_Z_p4->Pt()/1000,weight);
          r_jpt_zpt=ljet_0_p4->Pt()/Z_pt;
        }
        if (outside_lep) {
                  ...
                  if (cuts[5]==1) {
                    ...
                    if (cuts[6]==1) {
                      ...
                      if (inside) {
                        ...
                        h_Z_pt_truth_cuts_inside->Fill(truth_Z_p4->Pt()/1000,weight);
                      }
                      if (outside_lep) {
                        ...
                        h_Z_pt_truth_cuts_outside->Fill(truth_Z_p4->Pt()/1000,weight);
                      }
                      if (outside_tau){
                        h_reco_mass_met_outside_btag_iso_rnn_ptmu_omega_mreco->Fill(reco_mass_outside,weight);                      
                        h_Z_pt_reco_cuts_outside->Fill(Z_pt,weight);
                      ...
                      if (cuts[7]==1){
                        ...
                        if (inside) {
                          ...
                          h_Z_pt_truth_cuts_tpt_inside->Fill(truth_Z_p4->Pt()/1000,weight);
                        }
                        if (outside_lep) {
                          ...
                          h_Z_pt_truth_cuts_tpt_outside->Fill(truth_Z_p4->Pt()/1000,weight);
                        }
                        if (outside_tau){
                          h_reco_mass_met_outside_btag_iso_rnn_ptmu_omega_mreco_tpt->Fill(reco_mass_outside,weight);
                          h_lep_pt1_btag_iso_rnn_ptmu_omega_mreco_tpt_outside->Fill(tau_0_p4->Pt(),weight);                       

...
void CLoop::Book() {
    ...
    h_inva_mass_ltau_btag_iso_rnn_ptmu_omega_mreco_tpt = new TH1F("inva_mass_ltau_btag_iso_rnn_ptmu_omega_mreco_tpt","Invariant mass lepton-tau system _btag_iso_rnn_ptmu_omega_mreco_tpt",300,0,300);
    ...
    h_b_tag_iso_rnn_ptmu_omega_mreco_tpt = new TH1F("b_tag_iso_rnn_ptmu_omega_mreco_tpt","b taging variable_iso_rnn_ptmu_omega_mreco_tpt",100,-1,1);
    ...
    h_muon_0_iso_FCTightTrackOnly_FixedRad_btag_iso2_rnn_ptmu_omega_mreco_tpt = new TH1F("muon_0_iso_FCTightTrackOnly_FixedRad_btag_iso2_rnn_ptmu_omega_mreco_tpt","lepton isolation_btag_iso2_rnn_ptmu_omega_mreco_tpt",20,0,10);
...
void CLoop::Fill(double weight) {
    ...
    if (n_muons==1 && n_taus==1 && trigger_decision && lepton_id && trigger_match) {
      ...
      if (ql!=qtau && angle<3*pi/4){
        ...
        vector<int> c_tpt={1,1,1,1,1,1,0,1};
